...
{
    class Periodic_Pos : TimerSet
    {
        private FltPositionMsg dataitem = new FltPositionMsg();
        private Positions_Log datalog = new Positions_Log("../../../Content/Files/Msg2DMM.csv");
